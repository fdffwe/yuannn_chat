...
static const char* ChatService_method_names[] = {
  ...
  "/message.ChatService/FetchMessages",
};
...
ChatService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_FetchMessages_(ChatService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status ChatService::Stub::FetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::message::FetchMsgsRsp* response) {
  return ::grpc::internal::BlockingUnaryCall< ::message::FetchMsgsReq, ::message::FetchMsgsRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_FetchMessages_, context, request, response);
}

void ChatService::Stub::async::FetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq* request, ::message::FetchMsgsRsp* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::message::FetchMsgsReq, ::message::FetchMsgsRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_FetchMessages_, context, request, response, std::move(f));
}

void ChatService::Stub::async::FetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq* request, ::message::FetchMsgsRsp* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_FetchMessages_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::message::FetchMsgsRsp>* ChatService::Stub::PrepareAsyncFetchMessagesRaw(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::message::FetchMsgsRsp, ::message::FetchMsgsReq, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_FetchMessages_, context, request);
}

::grpc::ClientAsyncResponseReader< ::message::FetchMsgsRsp>* ChatService::Stub::AsyncFetchMessagesRaw(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncFetchMessagesRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
ChatService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ChatService::Service, ::message::FetchMsgsReq, ::message::FetchMsgsRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ChatService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::message::FetchMsgsReq* req,
             ::message::FetchMsgsRsp* resp) {
               return service->FetchMessages(ctx, req, resp);
             }, this)));
}
...
::grpc::Status ChatService::Service::FetchMessages(::grpc::ServerContext* context, const ::message::FetchMsgsReq* request, ::message::FetchMsgsRsp* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
