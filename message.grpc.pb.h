 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status FetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::message::FetchMsgsRsp* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::FetchMsgsRsp>> AsyncFetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::FetchMsgsRsp>>(AsyncFetchMessagesRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::FetchMsgsRsp>> PrepareAsyncFetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::FetchMsgsRsp>>(PrepareAsyncFetchMessagesRaw(context, request, cq));
    }
    class async_interface {
     public:
      virtual ~async_interface() {}
      ...
      virtual void FetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq* request, ::message::FetchMsgsRsp* response, std::function<void(::grpc::Status)>) = 0;
      virtual void FetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq* request, ::message::FetchMsgsRsp* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
    typedef class async_interface experimental_async_interface;
    virtual class async_interface* async() { return nullptr; }
    class async_interface* experimental_async() { return async(); }
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::message::FetchMsgsRsp>* AsyncFetchMessagesRaw(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::message::FetchMsgsRsp>* PrepareAsyncFetchMessagesRaw(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
    ...
    ::grpc::Status FetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::message::FetchMsgsRsp* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::FetchMsgsRsp>> AsyncFetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::FetchMsgsRsp>>(AsyncFetchMessagesRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::FetchMsgsRsp>> PrepareAsyncFetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::FetchMsgsRsp>>(PrepareAsyncFetchMessagesRaw(context, request, cq));
    }
    class async final :
      public StubInterface::async_interface {
     public:
      ...
      void FetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq* request, ::message::FetchMsgsRsp* response, std::function<void(::grpc::Status)>) override;
      void FetchMessages(::grpc::ClientContext* context, const ::message::FetchMsgsReq* request, ::message::FetchMsgsRsp* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
      explicit async(Stub* stub): stub_(stub) { }
      Stub* stub() { return stub_; }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::message::FetchMsgsRsp>* AsyncFetchMessagesRaw(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::message::FetchMsgsRsp>* PrepareAsyncFetchMessagesRaw(::grpc::ClientContext* context, const ::message::FetchMsgsReq& request, ::grpc::CompletionQueue* cq) override;
    ...
    const ::grpc::internal::RpcMethod rpcmethod_FetchMessages_;
  };
  static std::unique_ptr<Stub> NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status FetchMessages(::grpc::ServerContext* context, const ::message::FetchMsgsReq* request, ::message::FetchMsgsRsp* response);
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithAsyncMethod_FetchMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_FetchMessages() {
      ::grpc::Service::MarkMethodAsync(6);
    }
    ~WithAsyncMethod_FetchMessages() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchMessages(::grpc::ServerContext* /*context*/, const ::message::FetchMsgsReq* /*request*/, ::message::FetchMsgsRsp* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestFetchMessages(::grpc::ServerContext* context, ::message::FetchMsgsReq* request, ::grpc::ServerAsyncResponseWriter< ::message::FetchMsgsRsp>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(6, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_NotifyAddFriend<WithAsyncMethod_RplyAddFriend<WithAsyncMethod_SendChatMsg<WithAsyncMethod_NotifyAuthFriend<WithAsyncMethod_NotifyTextChatMsg<WithAsyncMethod_NotifyKickUser<WithAsyncMethod_FetchMessages<Service > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithCallbackMethod_FetchMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_FetchMessages() {
      ::grpc::Service::MarkMethodCallback(6,
          new ::grpc::internal::CallbackUnaryHandler< ::message::FetchMsgsReq, ::message::FetchMsgsRsp>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::message::FetchMsgsReq* request, ::message::FetchMsgsRsp* response) { return this->FetchMessages(context, request, response); }));}
    void SetMessageAllocatorFor_FetchMessages(
        ::grpc::MessageAllocator< ::message::FetchMsgsReq, ::message::FetchMsgsRsp>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(6);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::message::FetchMsgsReq, ::message::FetchMsgsRsp>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_FetchMessages() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchMessages(::grpc::ServerContext* /*context*/, const ::message::FetchMsgsReq* /*request*/, ::message::FetchMsgsRsp* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* FetchMessages(
      ::grpc::CallbackServerContext* /*context*/, const ::message::FetchMsgsReq* /*request*/, ::message::FetchMsgsRsp* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_NotifyAddFriend<WithCallbackMethod_RplyAddFriend<WithCallbackMethod_SendChatMsg<WithCallbackMethod_NotifyAuthFriend<WithCallbackMethod_NotifyTextChatMsg<WithCallbackMethod_NotifyKickUser<WithCallbackMethod_FetchMessages<Service > > > > > > > CallbackService;
  typedef CallbackService ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithGenericMethod_FetchMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_FetchMessages() {
      ::grpc::Service::MarkMethodGeneric(6);
    }
    ~WithGenericMethod_FetchMessages() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchMessages(::grpc::ServerContext* /*context*/, const ::message::FetchMsgsReq* /*request*/, ::message::FetchMsgsRsp* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_FetchMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_FetchMessages() {
      ::grpc::Service::MarkMethodRaw(6);
    }
    ~WithRawMethod_FetchMessages() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchMessages(::grpc::ServerContext* /*context*/, const ::message::FetchMsgsReq* /*request*/, ::message::FetchMsgsRsp* /*response*/) override {
    ...
    void RequestFetchMessages(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(6, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_FetchMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_FetchMessages() {
      ::grpc::Service::MarkMethodRawCallback(6,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->FetchMessages(context, request, response); }));
    }
    ~WithRawCallbackMethod_FetchMessages() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchMessages(::grpc::ServerContext* /*context*/, const ::message::FetchMsgsReq* /*request*/, ::message::FetchMsgsRsp* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_FetchMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_FetchMessages() {
      ::grpc::Service::MarkMethodStreamed(6,
        new ::grpc::internal::StreamedUnaryHandler<
          ::message::FetchMsgsReq, ::message::FetchMsgsRsp>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::message::FetchMsgsReq, ::message::FetchMsgsRsp>* streamer) {
                       return this->StreamedFetchMessages(context,
                         streamer);
                  }));
    }
    ~WithStreamedUnaryMethod_FetchMessages() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status FetchMessages(::grpc::ServerContext* /*context*/, const ::message::FetchMsgsReq* /*request*/, ::message::FetchMsgsRsp* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedFetchMessages(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::message::FetchMsgsReq,::message::FetchMsgsRsp>* server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_NotifyAddFriend<WithStreamedUnaryMethod_RplyAddFriend<WithStreamedUnaryMethod_SendChatMsg<WithStreamedUnaryMethod_NotifyAuthFriend<WithStreamedUnaryMethod_NotifyTextChatMsg<WithStreamedUnaryMethod_NotifyKickUser<WithStreamedUnaryMethod_FetchMessages<Service > > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_NotifyAddFriend<WithStreamedUnaryMethod_RplyAddFriend<WithStreamedUnaryMethod_SendChatMsg<WithStreamedUnaryMethod_NotifyAuthFriend<WithStreamedUnaryMethod_NotifyTextChatMsg<WithStreamedUnaryMethod_NotifyKickUser<WithStreamedUnaryMethod_FetchMessages<Service > > > > > > > StreamedService;
};
